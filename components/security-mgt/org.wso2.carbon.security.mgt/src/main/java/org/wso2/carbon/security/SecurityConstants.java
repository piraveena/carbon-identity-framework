...
public class SecurityConstants {
    ...
    public static class KeyStoreMgtConstants {
        ...
        public enum ErrorMessage {
            ...
            ERROR_CODE_NO_PRIVATE_KEY_FOR_THE_GIVEN_ALIAS("KSS-60007", "No any private keys exists for the alias %s."),
            ERROR_CODE_AN_ENTRY_FOR_THE_GIVEN_ALIAS_EXISTS("KSS-60008", "Keystore already contains " +
                    "an entry with the alias: %s."),
            ERROR_CODE_ONLY_ONE_PRIVATE_KEY_EXISTS("KSS-60009", "This alias %s is the only private key " +
                    "exists in the keystore"),
            ERROR_CODE_UNSUPPORTED_DELETION_OF_SIGNING_KEY("KSS-60010", "This alias %s is used as signing key " +
                    "in the keystore"),
            // Unsupported super tenant operations related to private keys.
            ERROR_CODE_UNSUPPORTED_DELETION_FOR_SUPER_TENANT("KSS-60011", "Deleting the alias %s from " +
                    "super tenant keystore is not supported"),
            ERROR_CODE_UNSUPPORTED_ADDING_KEYS_FOR_SUPER_TENANT("KSS-60012", "Adding keys for super " +
